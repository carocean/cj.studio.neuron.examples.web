package your.crop.examples.net.udt;
...
/**
 * 注：对应用netty实现的UdtNettyServer,UdtNettyClient与用法与此类似，但对持响应式的支持性能没有rio的好
 * @author carocean
 *
 */
@CjService(name="rioudt",isExoteric=true)
public class TestRioUdt {


	public void testRioudt()
